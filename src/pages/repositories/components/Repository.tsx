  ...
  <article className='Box-row'>
    <div className='float-right d-flex'>
      ...
      >
        <svg
          ...
          version='1.1'
          width='16'
          className='octicon octicon-star v-align-text-bottom mr-1'
        >
          <path
            fillRule='evenodd'
    ...
    <h1 className='h3 lh-condensed'>
      <a href={url}>
        ...
        <span className='text-normal'>{username} /</span>&nbsp;{repositoryName}
      </a>
    </h1>
    ...
    <div className='f6 color-text-secondary mt-2'>
      ...
      <span className='d-inline-block mr-3'>
        Built by&nbsp;
        {builtBy.map(contributor => (
          <a key={contributor.username} className='d-inline-block mr-1' href={contributor.url}>
            <img
